...
class LogPaymentNotificationJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        //dd('hi');
        Log::info('Starting LogPaymentNotificationJob');
        ...
        try {
            Log::info('Sending payment notification request to external API');
            ...
            Log::info('payment Notification Response Received', [
            ...
            Log::info('Logged failed payment notification to DB');
            ...
            Log::info('Logged general exception to DB');
        }
    }
}
