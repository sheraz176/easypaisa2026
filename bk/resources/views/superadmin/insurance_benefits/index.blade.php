...
@section('title')
    <title>Insurance Benefit || Index</title>
@endsection
@push('styles')
    <!-- Datatable -->
                ...
                <div class="card stretch stretch-full">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table id="benefitsTable" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Package Name</th>
    ...
    <script>
        $(document).ready(function() {
            $('#benefitsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('superadmin.insurancebenefits.index') }}',
