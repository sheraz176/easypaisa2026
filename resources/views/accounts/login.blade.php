...
<head>
    ...
    <title>EasyPaisa || Login Accounts</title>
                    ...
                    <div class="row flex-1 g-0">
                        ...
                        <div class="col-lg-6 h-100 my-auto">
                            ...
                            <img src="{{ asset('assets/images/logo-abbr.png') }}" alt="Logo" class="mb-4" style="max-width: 250px;">
                                  ...
                                  <h4 class="fs-13 fw-bold mb-2">Accounts Control for Easypaisa Digital Saving</h4>
                             ...
                             @endif
                               ...
                               <form class="w-100 mt-4 pt-2" action="{{ route('accounts.loginform') }}" method="post">
                                   @csrf
                                   <div class="mb-4">
