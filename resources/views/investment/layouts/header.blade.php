            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h6 class="text-dark mb-0">{{ Auth::user()->firstname }}<span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                   @else
                                    Guest
                                    @endif
                        ...
                        <form id="logout-form" action="{{ route('investment.logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                    </div>
                </div>
